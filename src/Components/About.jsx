...
export const About = () => {
  return (
    <section name='About' className='w-[90%] xl:w-[80%] max-md:w-[80%] mx-auto pt-16'>
      <div className='md:grid md:grid-cols-2'>
        <div className='m-10' >
          <div className='md:flex md:justify-center '>
            ...
            <div className='flex flex-col text-center ml-4'>
              <p className='mt-4'><span className='font-bold'>Name:</span> Matias Ceferino Bruno</p>
              <p className='mt-4'><span className='font-bold'>Profile:</span> Front End Developer</p>
              <motion.a
          ...
          <div>
            <div className='mt-10 '>
              ...
              <div className='grid grid-cols-3  justify-items-center mt-4 gap-4 sm:w-[70%] mx-auto '>
                ...
                <img className='w-[70px]' src={imgWordpress} alt="Logo Wordpress" />
        ...
        <div>
          <h3 className='font-Oswald uppercase font-bold text-[50px] md:mb-10 md:pt-10 border-b md: border-blue-700 mx-auto w-[250px] text-center '>About me</h3>
          <p className='p-4 mb-[-10px] text-xl font-light'>I trained in Full Stack Web Development motivated by the curiosity that the IT world awakened in me.</p>
          <p className='p-4 mb-[-10px] text-xl font-light'>That same curiosity motivated me to go deeper into the development of technologies, learning in a self-taught and constant way, which allowed me to take my first steps as a professional.</p>
          <p className='p-4 mb-[-10px] text-xl font-light'>I was looking to be part of a team where I could collaborate to face ambitious projects, with creativity, flexibility and initiative.
          </p>
        </div>
      </div>
    </section>
